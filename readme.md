##### Косяки и планы:
1. Отчистка таблицы без введенных параметров не работает
2. Стилизовать вторую страницу 
3. Добавить точку на SVG
4. Добавить ввод координат по нажатию на SVG
